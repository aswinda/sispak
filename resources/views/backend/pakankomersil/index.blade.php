...
<div class="panel col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h1 class="page-header">Pakan</h1>
      ...
      <a href="{{ URL::to('admin/pakankomersil/create') }}" style="margin-bottom : 10px;" type="button" class="col-sm-offset-11 btn btn-primary push-right">Tambah</a>
      ...
      <table id="example1" class="table table-striped">
         ...
         <tbody>
          <?php $tmp = 0; ?>
            ...
            <td>
                 <?php foreach($pakan->fish AS $fish) echo $fish->name.", "; ?>
            </td>
            ...
            <td>
              ...
              <form class="form-inline" role="form" method="POST" action="{{ url('admin/pakankomersil/delete/'.$pakan->id) }}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 <a class="btn btn-warning" href="{{ URL::To('admin/pakankomersil/edit/'.$pakan->id) }}">Edit</a>

...
<div class="panel col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h1 class="page-header">Ikan</h1>
      <?php if (session()->has('message')) echo session('message'); ?>
      
      <a href="{{ URL::to('admin/ikan/create') }}" style="margin-bottom : 10px;" type="button" class="col-sm-offset-11 btn btn-primary push-right">Tambah</a>
         ...
         <tbody>
          <?php $tmp = 0; ?>
            ...
            <td>
              ...
              <form class="form-inline" role="form" method="POST" action="{{ url('admin/ikan/delete/'.$fish->id) }}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 <a class="btn btn-warning" href="{{ URL::To('admin/ikan/edit/'.$fish->id) }}">Edit</a>
